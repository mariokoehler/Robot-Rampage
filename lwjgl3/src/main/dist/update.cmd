@echo off
rem Robot Rampage client updater (design.md 3.11). Migrated verbatim from the
rem StarWars project's identical script, renamed for this repo/app.
rem
...
set "REPO_NAME=Robot-Rampage"
set "ASSET_NAME=RobotRampage-Client.zip"
set "APP_EXE=RobotRampage.exe"
...
set "INSTALL_DIR=%~dp0"
set "TEMP_COPY=%TEMP%\RobotRampage-update-%RANDOM%.cmd"
...
if not errorlevel 1 (
    echo Robot Rampage is currently running. Please close it, then run update.cmd again.
    pause
    exit /b 1
)
...
set "STAGE_DIR=%TEMP%\RobotRampage-update-stage-%RANDOM%"
...
set "NEW_ROOT=%EXTRACT_DIR%\RobotRampage"
...
if "%SWAP_OK%"=="1" (
    ...
    echo Done. Starting Robot Rampage...
